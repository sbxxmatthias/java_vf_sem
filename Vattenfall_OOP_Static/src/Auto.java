...
public class Auto {
	...
	public static void showKilometer() {
		System.out.println(alleKilometer);
	}
	
	// nur Zugriff auf static ! kein this
	public static void addKilometer(double strecke) {
		alleKilometer += strecke;
		// this.kilometer 
	}
	...
	public static void main(String[] args) {
		...
		// "Sportwagen" Fahrzeugtyp.Sportwagen
...
//		bmw.fz = Fahrzeugtyp.Sportwagen;
		...
		// static Methoden werden dann verwendet, wenn man nicht auf den Daten eines 
		// Objektes arbeiten muss und wird gerne gemacht bei Hilfsfunktionen
		System.out.println(Math.PI);
		// Verwendung einer Operation auch ohne Objekt möglich
		Math.sqrt(9);
		// Wrapper-Klassen
		// Aufruf mit Klassen- und Methodenname OHNE Objektinstanz !
